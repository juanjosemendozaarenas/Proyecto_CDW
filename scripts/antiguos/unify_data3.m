...
for i=1:length(U)
    ...
    fname1 = ['/output/TC' sim2 '_dbl/TimeCorrel_FH' sim ...
    ...
    fname2 = ['/output/TE' sim2 '/TimeCorrel_FH' sim ...
    ...
    fname3 = ['/output/TC' sim2 '_nup/TimeCorrel_FH' sim ...
    ...
    fname3 = ['/output/TC' sim2 '_ndn/TimeCorrel_FH' sim ...
    ...
    %% Load chi and E
    fname4 = ['/output/GS' sim2 '/GS_FH' sim '_L' num2str(L) '_J1_U'...
        num2str(U(i), '%.2f') '_V' num2str(V) '_chi1000.mat'];
    load(fname4,'E');
    load(fname4,'chi');
    load(fname4,'nup');
    check = exist('nup');
    if check == 0
        fname4 = ['/output/ExOps' sim2 '/GS_FH' sim '_L' num2str(L) '_J1_U'...
        num2str(U(i), '%.2f') '_V' num2str(V) '_chi1000.mat'];
        load(fname4,'dbl');
        load(fname4,'sz');
        load(fname4,'nup');
