...
V = -0.2; % Nearest-neighbour Coulomb interaction
...
for count_file = 1:size(U_array,2)
    ...
    gsfile = ['GS_FH4a_L' num2str(L) '_J' num2str(J) '_U' num2str(U,'%.2f') '_V' num2str(V) '_chi' num2str(chi_max_gs) '.mat'];
    
    % Name of file where results of time evolution will be saved
    savefile = ['TimeCorrel_FH4a_' correl_oper_text '_L' num2str(L) '_J' num2str(J) '_U' num2str(U,'%.2f') '_V' num2str(V) '_chi' num2str(chi_max) '_dt' num2str(dt) '_era' num2str(era) '.mat'];
    
    % Name of files where state of previous era was saved, and where state of current era will be saved
    prev_era_state = ['State_TimeCorrel_FH4a_' correl_oper_text '_L' num2str(L) '_J' num2str(J) '_U' num2str(U,'%.2f') '_V' num2str(V) '_chi' num2str(chi_max) '_dt' num2str(dt) '_era' num2str(prev_era) '.mat'];
    curr_era_state = ['State_TimeCorrel_FH4a_' correl_oper_text '_L' num2str(L) '_J' num2str(J) '_U' num2str(U,'%.2f') '_V' num2str(V) '_chi' num2str(chi_max) '_dt' num2str(dt) '_era' num2str(era) '.mat'];
    
    % Saving current information
    fname = ['./initfiles/initial_TimeCorrel_FH4a' num2str(count_file+add_to_file) '.mat'];
    save(fname);
